export default function Header({startProposal,endProposal,startVoting,endVoting,startTallied}) {
  return (
        ...
        <main className="mt-7 mx-auto max-w-7xl px-4 ">
          <div className="text-center">
            <h1 className="text-4xl tracking-tight font-extrabold text-gray-900 sm:text-5xl md:text-6xl">
              <span className="block text-indigo-600 xl:inline">Decentralized Voting System</span>
            </h1>
            <p className="mt-3 max-w-md mx-auto text-base text-gray-500 sm:text-lg md:mt-5 md:text-xl md:max-w-3xl">
              workflowStatus status button are admin only
            </p>
            <div className="mt-5 max-w-md mx-auto sm:flex sm:justify-center md:mt-8">
             ...
             <p className="mt-20">ici j'afficherais le résultat</p>
          </div>
        </main>
      </div>
    </div>
